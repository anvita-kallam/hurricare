    ...
    return (
      <div className="space-y-6 py-8">
        <div className="text-center">
          <div className="text-white/85 font-rajdhani text-sm tracking-[0.3em] uppercase">
            Loading Results
          </div>
          <div className="text-white/85 font-mono text-sm mt-2">
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="text-center space-y-1">
        <TypewriterText text="Response Outcome" emphasis="soft" delayMs={100} className="text-white/85 font-rajdhani text-sm tracking-[0.3em] uppercase" as="div" />
          ...
          <div className="flex items-center justify-between mb-2">
            ...
            <div className="flex items-center gap-3">
              <div className="flex items-center gap-1">
                ...
                <span className="text-white/85 font-mono text-xs">Your Plan</span>
              </div>
              <div className="flex items-center gap-1">
                <div className="w-2 h-2 rounded-sm" style={{ background: 'rgba(136,85,170,0.6)' }} />
                <span className="text-white/85 font-mono text-xs">ML Ideal</span>
              </div>
            </div>
          </div>
      ...
      <div className="text-center border-t border-white/[0.12] pt-4">
        <div className="text-white/90 font-mono text-sm leading-relaxed max-w-md mx-auto">
