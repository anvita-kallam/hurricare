...
const BRIGHT_STARS = [
  { name: 'Dubhe', ra: 11.06, dec: 61.9, mag: 1.9, color: '#dddddd' },
  { name: 'Merak', ra: 11.03, dec: 56.4, mag: 2.3, color: '#cccccc' },
  { name: 'Phad', ra: 11.53, dec: 53.4, mag: 2.4, color: '#cccccc' },
  { name: 'Megrez', ra: 12.26, dec: 57.0, mag: 3.3, color: '#ffffff' },
  { name: 'Alioth', ra: 12.90, dec: 55.9, mag: 1.8, color: '#cccccc' },
  { name: 'Mizar', ra: 13.40, dec: 54.9, mag: 2.2, color: '#cccccc' },
  { name: 'Alkaid', ra: 13.79, dec: 49.3, mag: 1.9, color: '#bbbbbb' },
  { name: 'Polaris', ra: 2.53, dec: 89.3, mag: 2.0, color: '#ffffff' },
  { name: 'Kochab', ra: 15.73, dec: 74.2, mag: 2.1, color: '#dddddd' },
  { name: 'Rigel', ra: 5.24, dec: -8.2, mag: 0.1, color: '#bbbbbb' },
  { name: 'Betelgeuse', ra: 5.92, dec: 7.4, mag: 0.5, color: '#eeeeee' },
  { name: 'Bellatrix', ra: 5.42, dec: 6.3, mag: 1.6, color: '#cccccc' },
  { name: 'Alnilam', ra: 5.60, dec: -1.2, mag: 1.7, color: '#cccccc' },
  { name: 'Schedar', ra: 0.68, dec: 56.5, mag: 2.2, color: '#dddddd' },
  { name: 'Caph', ra: 2.30, dec: 59.1, mag: 2.3, color: '#ffffff' },
  { name: 'Gamma Cas', ra: 3.67, dec: 60.7, mag: 2.4, color: '#cccccc' },
  { name: 'Deneb', ra: 20.69, dec: 45.3, mag: 1.3, color: '#ffffff' },
  { name: 'Albireo', ra: 19.50, dec: 27.7, mag: 3.1, color: '#dddddd' },
  { name: 'Sadr', ra: 20.37, dec: 40.0, mag: 2.2, color: '#dddddd' },
  { name: 'Vega', ra: 18.62, dec: 38.8, mag: 0.0, color: '#cccccc' },
  { name: 'Altair', ra: 19.85, dec: 8.9, mag: 0.8, color: '#cccccc' },
  { name: 'Sheliak', ra: 18.98, dec: 33.4, mag: 3.2, color: '#cccccc' },
  { name: 'Alshain', ra: 19.98, dec: 8.4, mag: 3.9, color: '#dddddd' },
  { name: 'Arcturus', ra: 14.26, dec: 19.2, mag: -0.1, color: '#dddddd' },
  { name: 'Spica', ra: 13.42, dec: -11.2, mag: 1.0, color: '#bbbbbb' },
  { name: 'Antares', ra: 16.49, dec: -26.4, mag: 1.0, color: '#eeeeee' },
  { name: 'Aldebaran', ra: 4.60, dec: 16.5, mag: 0.9, color: '#dddddd' },
  { name: 'Sirius', ra: 6.75, dec: -16.7, mag: -1.5, color: '#ffffff' },
  { name: 'Capella', ra: 5.28, dec: 46.0, mag: 0.1, color: '#dddddd' },
  { name: 'Pollux', ra: 7.76, dec: 28.0, mag: 1.1, color: '#dddddd' },
  { name: 'Procyon', ra: 7.65, dec: 5.2, mag: 0.4, color: '#cccccc' },
  { name: 'Regulus', ra: 10.14, dec: 11.9, mag: 1.4, color: '#cccccc' },
  { name: 'Denebola', ra: 11.82, dec: 14.6, mag: 2.1, color: '#cccccc' },
]
